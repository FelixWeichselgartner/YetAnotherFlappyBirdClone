...
public class Pipe {
    ...
    Pipe() {
        final int heightScale = 800, widthScale = 500;
        width = FlappyBird.WIDTH/widthScale*100;
        space = FlappyBird.HEIGHT/heightScale*170;
        this.counted = false;
    }
    ...
    public void setHeightUp(int newHU) {
        heightUp = newHU;
    }

    public void setHeightDown(int newHD) {
        heightDown = newHD;
    }
